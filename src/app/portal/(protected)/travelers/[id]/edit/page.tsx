  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        // Matches the rebuilt standalone Flight Edit page: separate
        // departure/arrival dates, departureAirport/arrivalAirport naming.
        setFlights(
    ...
    <div className="max-w-full mx-auto p-4 md:p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <SectionCard title="Hotels">
          {hotels.length === 0 && <p className="text-sm text-gray-400 mb-3">No hotels added.</p>}
        ...
        <SectionCard title="Transports">
          {transports.length === 0 && <p className="text-sm text-gray-400 mb-3">No transports added.</p>}
          <div className="space-y-4">
        ...
        <SectionCard title="Flights">
          {flights.length === 0 && <p className="text-sm text-gray-400 mb-3">No flights added.</p>}
          <div className="space-y-4">
        ...
        <SectionCard title="Visas">
          {visas.length === 0 && <p className="text-sm text-gray-400 mb-3">No visa applicants added.</p>}
          <div className="space-y-4">
            {visas.map((row, index) => (
