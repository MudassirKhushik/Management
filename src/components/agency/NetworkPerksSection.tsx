    ...
    <section className="py-24 bg-tct-cream">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {perks.map((perk, i) => (
            <Reveal key={perk.title} delay={Math.min(i, 5) * 100}>
              <div className="bg-white rounded-2xl p-8 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 group">
